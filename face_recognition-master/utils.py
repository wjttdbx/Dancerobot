...
#   File name   : utils.py
#   Author      : YunYang1994
#   Created date: 2020-02-21 01:18:15
#   Description :
#
# ================================================================
...
persons = os.listdir(r"C:\Users\wjttdbx\Desktop\xm_vision\xm_vision\src\scripts\face_recognition-master\database")
print(persons)


def recognize_face(q_emb, threshold=0.89):
    database_embeddings = {p: np.load("face_recognition-master/database/%s/%s.npy" % (p, p)) for p in persons}
    p_score = {}
